...
class PromptModel:
    ...
    def build_prompt(self, prompt_train_rows: List[Dict[str, Any]]) -> Tuple[Dict[str, str], List[Dict[str, str]]]:
        ...
        system_msg = {
            ...
            "content": (
                "あなたは数学を専攻する大学教授です。"
                "今からいくつかの質問に対して段階的思考を行い解答を出力してください。"
                "与えられた問題をよく整理してから解答してください。"
                "使う定理や公式をよく考えてから解答をしてください。"
                "計算はミスがないように整理しながら、ダブルチェックしながら行ってください。"
                "考えた結論と問題の整合性を確認してください。"
